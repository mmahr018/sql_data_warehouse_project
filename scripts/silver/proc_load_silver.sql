...
Actions Performed:
    - Truncates Silver tables before loading clean data.
    - Applies data cleansing and standardization transformations.
    - Loads CRM tables first, followed by ERP tables.
    - Prints execution messages and load durations for monitoring.
